...
public class CreateNetCdf3 {
	...
	public static void main(String[] args) throws InvalidRangeException {
		...
		Variable.Builder varBuilderSR = builder.addVariable("spatial_ref", DataType.CHAR, spatialRefDims);
		...
		Variable.Builder varBuilderlat = builder.addVariable("lat", DataType.FLOAT, latLonDims);
		...
		// 3. Longitude
		Variable.Builder varBuilderlon = builder.addVariable("lon", DataType.FLOAT, latLonDims);
		...
		Variable.Builder varBuilderTime = builder.addVariable("time", DataType.INT, timeDims);
		...
		Variable.Builder varBuilderMainVar = builder.addVariable("tas", DataType.FLOAT, mainVarDims);
