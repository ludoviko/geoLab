...
public class CreateNetCdfBack {
	...
	public static void main(String[] args) throws InvalidRangeException {
		...
		// 3. Longitude
		List<Dimension> latLonDims2 = new ArrayList<Dimension>();
		latLonDims2.add(latDim);
		latLonDims2.add(lonDim);		

		String nameLon = "lon"; 
		Variable.Builder varBuilderlon = builder.addVariable(nameLon, DataType.FLOAT, latLonDims2);
